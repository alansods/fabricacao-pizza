    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          <li>150g de doce leite</li>
          <li>300g de banana</li>
          <li>Extras: leite condensado para decorar</li>
        </ul>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Banana com Doce de Leite",
  components: {},
  data() {
    return {};
  },
