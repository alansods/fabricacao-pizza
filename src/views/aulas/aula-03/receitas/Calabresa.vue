    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          <li>
            150g de calabresa cortada em rodelas finas
          </li>
          ...
          <li>
            Extras: azeitonas, orégano, azeite e cebola (QB – quanto baste)
          </li>
        </ul>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Calabresa",
  components: {},
  data() {
    return {};
  },
