    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          ...
          <li>
            Extras: azeitonas, orégano, azeite e cebola roxa (QB – quanto baste)
          </li>
        </ul>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Carne de Sol",
  components: {},
  data() {
    return {};
  },
