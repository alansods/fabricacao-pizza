    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          ...
          <li>30g de granulado</li>
          <li>Extras: morangos e cerejas (com cabo)</li>
        </ul>
      </div>
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ol class="lista-numerica">
          <li>Derreter o chocolate</li>
          <li>Montagem conforme a demonstração do instrutor.</li>
        </ol>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Chocolate",
  components: {},
  data() {
    return {};
  },
