    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          ...
          <li>200g de frango</li>
          <li>200g de catupiry</li>
          <li>70g de molho de tomate</li>
          <li>Extras: azeitonas, orégano,milho verde, azeite e cebola (QB – quanto baste)</li>
        </ul>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Frango com Requeijão",
  components: {},
  data() {
    return {};
  },
