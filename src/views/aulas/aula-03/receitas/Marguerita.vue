    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          ...
          <li>50g de tomate CEREJA</li>
          <li>5g de manjericão fresco</li>
          <li>Extras: orégano, azeite (QB – quanto baste)</li>
        </ul>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Marguerita",
  components: {},
  data() {
    return {};
  },
