    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          <li>300g de queijo mussarela ralado para uma pizza grande (base de massa de 350g).</li>
          <li>70g de molho de tomate</li>
          <li>1 unidade de tomate em rodelas</li>
          <li>Extras: azeitonas, orégano, azeite e cebola (QB – quanto baste)</li>
        </ul>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Mussarela",
  components: {},
  data() {
    return {};
  },
