    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          <li>150g de queijo mussarela</li>
          <li>100g de presunto</li>
          <li>80g de calabresa</li>
          <li>100g de ovos cozidos</li>
          <li>70g de molho de tomate</li>
          <li>
            Extras: azeitonas verde e pretas, pimentão verde, orégano, azeite e
            cebola (QB – quanto baste)
          </li>
        </ul>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Portuguesa",
  components: {},
  data() {
    return {};
  },
